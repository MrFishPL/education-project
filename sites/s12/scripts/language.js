...
function translate() {
    if (language == true) {
        ...
        $('.text14').text('"Dom Chopinów był czysto polski. Nie można było sprawić Fryderykowi większej przykrości, jak kwestionując jego tytuł Polaka, z powodu francuzkiego nazwiska".');
        ...
        $('.text5').text("The technique of playing took you very little time. Your fingers strained less than the mind, others spent days fiddling with the keyboard, you rarely spent an hour with it.");
